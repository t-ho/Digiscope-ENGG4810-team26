...
extern void WaveGenEnableSet(_Bool on);
extern _Bool WaveGenEnableGet(void);
...
extern void OverVoltageWarn(uint8_t channel);
extern tPushButtonWidget OverVoltageAcknowledge;
...
static ti_sysbios_knl_Mailbox_Handle GraphicsMailbox;
...
tCanvasWidget menus[] =
{
    ...
    { { sizeof(tCanvasWidget), (tWidget *)(0), (tWidget *)(0), (tWidget *)(&main_menu_buttons), &SSD1289_Display, { 0, 25, (0) + (320) - 1, (25) + (180) - 1 }, CanvasMsgProc }, 0x00000002, 0x00000000, 0, 0, 0, 0, 0, 0 },
	
    { { sizeof(tCanvasWidget), (tWidget *)(0), (tWidget *)(0), (tWidget *)(&RangeBack), &SSD1289_Display, { 0, 25, (0) + (320) - 1, (25) + (180) - 1 }, CanvasMsgProc }, 0x00000002, 0x00000000, 0, 0, 0, 0, 0, 0 },
	
	{ { sizeof(tCanvasWidget), (tWidget *)(0), (tWidget *)(0), (tWidget *)(&TriggerArmBack), &SSD1289_Display, { 0, 25, (0) + (320) - 1, (25) + (180) - 1 }, CanvasMsgProc }, 0x00000002, 0x00000000, 0, 0, 0, 0, 0, 0 },
	
	{ { sizeof(tCanvasWidget), (tWidget *)(0), (tWidget *)(0), (tWidget *)(&TriggerThresholdBack), &SSD1289_Display, { 0, 25, (0) + (320) - 1, (25) + (180) - 1 }, CanvasMsgProc }, 0x00000002, 0x00000000, 0, 0, 0, 0, 0, 0 },
	
	{ { sizeof(tCanvasWidget), (tWidget *)(0), (tWidget *)(0), (tWidget *)(&WaveGen1Back), &SSD1289_Display, { 0, 25, (0) + (320) - 1, (25) + (180) - 1 }, CanvasMsgProc }, 0x00000002, 0x00000000, 0, 0, 0, 0, 0, 0 },
	
	{ { sizeof(tCanvasWidget), (tWidget *)(0), (tWidget *)(0), (tWidget *)(&WaveGen2Back), &SSD1289_Display, { 0, 25, (0) + (320) - 1, (25) + (180) - 1 }, CanvasMsgProc }, 0x00000002, 0x00000000, 0, 0, 0, 0, 0, 0 },
	
	{ { sizeof(tCanvasWidget), (tWidget *)(0), (tWidget *)(0), (tWidget *)(&BrightnessBack), &SSD1289_Display, { 0, 25, (0) + (320) - 1, (25) + (180) - 1 }, CanvasMsgProc }, 0x00000002, 0x00000000, 0, 0, 0, 0, 0, 0 },
	
	{ { sizeof(tCanvasWidget), (tWidget *)(0), (tWidget *)(0), (tWidget *)(&OverVoltageAcknowledge), &SSD1289_Display, { 0, 25, (0) + (320) - 1, (25) + (180) - 1 }, CanvasMsgProc }, 0x00000002, 0x00000000, 0, 0, 0, 0, 0, 0 },
};

void OnMAIN(tWidget *psWidget) { WidgetRemove((tWidget *)&menus[current_menu]); current_menu = MAIN_MENU; WidgetAdd(&g_sRoot, (tWidget *)&menus[current_menu]); do { tCanvasWidget *pW = &g_sTitle; const char *pcT = menu_titles[current_menu]; pW->pcText = pcT; } while(0); WidgetMessageQueueAdd(&g_sRoot, 0x00000001, 0, 0, 0, 0); }
void OnTRIGGER_ARM(tWidget *psWidget) { WidgetRemove((tWidget *)&menus[current_menu]); current_menu = TRIGGER_ARM_MENU; WidgetAdd(&g_sRoot, (tWidget *)&menus[current_menu]); do { tCanvasWidget *pW = &g_sTitle; const char *pcT = menu_titles[current_menu]; pW->pcText = pcT; } while(0); WidgetMessageQueueAdd(&g_sRoot, 0x00000001, 0, 0, 0, 0); }
void OnTRIGGER_THRESHOLD(tWidget *psWidget) { WidgetRemove((tWidget *)&menus[current_menu]); current_menu = TRIGGER_THRESHOLD_MENU; WidgetAdd(&g_sRoot, (tWidget *)&menus[current_menu]); do { tCanvasWidget *pW = &g_sTitle; const char *pcT = menu_titles[current_menu]; pW->pcText = pcT; } while(0); WidgetMessageQueueAdd(&g_sRoot, 0x00000001, 0, 0, 0, 0); }
void OnWAVEGEN1(tWidget *psWidget) { WidgetRemove((tWidget *)&menus[current_menu]); current_menu = WAVEGEN1_MENU; WidgetAdd(&g_sRoot, (tWidget *)&menus[current_menu]); do { tCanvasWidget *pW = &g_sTitle; const char *pcT = menu_titles[current_menu]; pW->pcText = pcT; } while(0); WidgetMessageQueueAdd(&g_sRoot, 0x00000001, 0, 0, 0, 0); }
void OnWAVEGEN2(tWidget *psWidget) { WidgetRemove((tWidget *)&menus[current_menu]); current_menu = WAVEGEN2_MENU; WidgetAdd(&g_sRoot, (tWidget *)&menus[current_menu]); do { tCanvasWidget *pW = &g_sTitle; const char *pcT = menu_titles[current_menu]; pW->pcText = pcT; } while(0); WidgetMessageQueueAdd(&g_sRoot, 0x00000001, 0, 0, 0, 0); }
static void OnBRIGHTNESS(tWidget *psWidget) { WidgetRemove((tWidget *)&menus[current_menu]); current_menu = BRIGHTNESS_MENU; WidgetAdd(&g_sRoot, (tWidget *)&menus[current_menu]); do { tCanvasWidget *pW = &g_sTitle; const char *pcT = menu_titles[current_menu]; pW->pcText = pcT; } while(0); WidgetMessageQueueAdd(&g_sRoot, 0x00000001, 0, 0, 0, 0); }
void OnOVERVOLTAGE(tWidget *psWidget) { WidgetRemove((tWidget *)&menus[current_menu]); current_menu = OVERVOLTAGE_MENU; WidgetAdd(&g_sRoot, (tWidget *)&menus[current_menu]); do { tCanvasWidget *pW = &g_sTitle; const char *pcT = menu_titles[current_menu]; pW->pcText = pcT; } while(0); WidgetMessageQueueAdd(&g_sRoot, 0x00000001, 0, 0, 0, 0); }
...
void OnRange_A(tWidget *psWidget)
{
    ...
    do { tCanvasWidget *pW = &g_sTitle; const char *pcT = "Channel A"; pW->pcText = pcT; } while(0);
	WidgetAdd(&g_sRoot, (tWidget *)&menus[current_menu]);
    WidgetMessageQueueAdd(&g_sRoot, 0x00000001, 0, 0, 0, 0);
}
...
void OnRange_B(tWidget *psWidget)
{
	...
	do { tCanvasWidget *pW = &g_sTitle; const char *pcT = "Channel B"; pW->pcText = pcT; } while(0);
	WidgetAdd(&g_sRoot, (tWidget *)&menus[current_menu]);
    WidgetMessageQueueAdd(&g_sRoot, 0x00000001, 0, 0, 0, 0);
}
...
tCanvasWidget g_sTitle = { { sizeof(tCanvasWidget), (tWidget *)(0), (tWidget *)(0), (tWidget *)(0), &SSD1289_Display, { 50, 2, (50) + (220) - 1, (2) + (20) - 1 }, CanvasMsgProc }, 0x00000004 | 0x00000020 | 0x00000002, 0, 0, 0x00FFFFFF, &g_sFontCm20, 0, 0, 0 };

static char ipaddrstring[32];
tCanvasWidget g_sConnStatus = { { sizeof(tCanvasWidget), (tWidget *)(0), (tWidget *)(0), (tWidget *)(0), &SSD1289_Display, { 50, 220, (50) + (220) - 1, (220) + (20) - 1 }, CanvasMsgProc }, 0x00000004 | 0x00000020 | 0x00000002, 0, 0, 0x00FFFFFF, &g_sFontCm20, ipaddrstring, 0, 0 };

tPushButtonWidget main_menu_buttons[] =
{
	{ { sizeof(tPushButtonWidget), (tWidget *)(&menus[MAIN_MENU]), (tWidget *)(main_menu_buttons + 1), (tWidget *)(0), &SSD1289_Display, { 0, 30, (0) + (100) - 1, (30) + (80) - 1 }, RectangularButtonMsgProc }, 0x00000002 | 0x00000004 | 0x00000001 | 0x00000080, 0x000000FF, 0x00FFFF00, 0x00FFFFFF, 0x00FFFFFF, &g_sFontCm18b, "Channel A", 0, 0, 0, 0, 0, OnRange_A },
	{ { sizeof(tPushButtonWidget), (tWidget *)(&menus[MAIN_MENU]), (tWidget *)(main_menu_buttons + 2), (tWidget *)(0), &SSD1289_Display, { 110, 30, (110) + (100) - 1, (30) + (80) - 1 }, RectangularButtonMsgProc }, 0x00000002 | 0x00000004 | 0x00000001 | 0x00000080, 0x000000FF, 0x00FFFF00, 0x00FFFFFF, 0x00FFFFFF, &g_sFontCm18b, "Channel B", 0, 0, 0, 0, 0, OnRange_B },
	{ { sizeof(tPushButtonWidget), (tWidget *)(&menus[MAIN_MENU]), (tWidget *)(main_menu_buttons + 3), (tWidget *)(0), &SSD1289_Display, { 220, 30, (220) + (100) - 1, (30) + (80) - 1 }, RectangularButtonMsgProc }, 0x00000002 | 0x00000004 | 0x00000001 | 0x00000080, 0x000000FF, 0x00FFFF00, 0x00FFFFFF, 0x00FFFFFF, &g_sFontCm18b, "Trigger", 0, 0, 0, 0, 0, OnTRIGGER_ARM },
	{ { sizeof(tPushButtonWidget), (tWidget *)(&menus[MAIN_MENU]), (tWidget *)(main_menu_buttons + 4), (tWidget *)(0), &SSD1289_Display, { 0, 120, (0) + (100) - 1, (120) + (80) - 1 }, RectangularButtonMsgProc }, 0x00000002 | 0x00000004 | 0x00000001 | 0x00000080, 0x000000FF, 0x00FFFF00, 0x00FFFFFF, 0x00FFFFFF, &g_sFontCm18b, "Brightness", 0, 0, 0, 0, 0, OnBRIGHTNESS },
	{ { sizeof(tPushButtonWidget), (tWidget *)(&menus[MAIN_MENU]), (tWidget *)(main_menu_buttons + 5), (tWidget *)(0), &SSD1289_Display, { 110, 120, (110) + (100) - 1, (120) + (80) - 1 }, RectangularButtonMsgProc }, 0x00000002 | 0x00000004 | 0x00000001 | 0x00000080, 0x000000FF, 0x00FFFF00, 0x00FFFFFF, 0x00FFFFFF, &g_sFontCm18b, "Sleep", 0, 0, 0, 0, 0, EnterSleep },
	{ { sizeof(tPushButtonWidget), (tWidget *)(&menus[MAIN_MENU]), (tWidget *)(0), (tWidget *)(0), &SSD1289_Display, { 220, 120, (220) + (100) - 1, (120) + (80) - 1 }, RectangularButtonMsgProc }, 0x00000002 | 0x00000004 | 0x00000001 | 0x00000080, 0x000000FF, 0x00FFFF00, 0x00FFFFFF, 0x00FFFFFF, &g_sFontCm18b, "Wave Gen", 0, 0, 0, 0, 0, OnWAVEGEN1 },
};
...
Repaint(tWidget *psWidget)
{
	...
	ti_sysbios_knl_Mailbox_post__E(GraphicsMailbox, &cmd, 0);
}

void
EnterSleep(tWidget *psWidget)
{
	SSD1289_Set_Backlight_On(0);
}
...
DrawTriggerIndicator(TriggerState state)
{
    ...
    do { tContext *pC = &sContext; pC->ui32Foreground = ((pC->psDisplay)->pfnColorTranslate((pC->psDisplay)->pvDisplayData, 0x00000000)); } while(0);
    GrRectFill(&sContext, (tRectangle*)&clrSquare);

    switch (state)
    {
    case TRIGGER_STATE_ARMED:
        do { tContext *pC = &sContext; pC->ui32Foreground = ((pC->psDisplay)->pfnColorTranslate((pC->psDisplay)->pvDisplayData, 0x00FFFF00)); } while(0);
        GrCircleFill(&sContext, 307, 12, 9);
        break;
    case TRIGGER_STATE_TRIGGERED:
        do { tContext *pC = &sContext; pC->ui32Foreground = ((pC->psDisplay)->pfnColorTranslate((pC->psDisplay)->pvDisplayData, 0x0090EE90)); } while(0);
        GrImageDraw(&sContext, arrow, 299, 5);
    	break;
    case TRIGGER_STATE_STOP:
    default:
        do { tContext *pC = &sContext; pC->ui32Foreground = ((pC->psDisplay)->pfnColorTranslate((pC->psDisplay)->pvDisplayData, 0x00FF0000)); } while(0);
...
{
	ti_sysbios_knl_Mailbox_post__E(GraphicsMailbox, cmd, timeout);
}
...
UI_Task(UArg arg0, UArg arg1)
{
    ...
    sRect.i16XMin = 0;
    sRect.i16YMin = 0;
    sRect.i16XMax = ((((&sContext)->psDisplay)->ui16Width)) - 1;
    sRect.i16YMax = 24;

    
    
    
    do { tContext *pC = &sContext; pC->ui32Foreground = ((pC->psDisplay)->pfnColorTranslate((pC->psDisplay)->pvDisplayData, 0x00FFFFFF)); } while(0);
    ...
    WidgetAdd(&g_sRoot, (tWidget *)&g_sTitle);
    WidgetAdd(&g_sRoot, (tWidget *)&g_sConnStatus);

    WidgetAdd(&g_sRoot, (tWidget *)&menus[MAIN_MENU]);

    do { tCanvasWidget *pW = &g_sTitle; const char *pcT = menu_titles[MAIN_MENU]; pW->pcText = pcT; } while(0);
    ...
    while (1)
    {
    	if (ti_sysbios_knl_Mailbox_pend__E(GraphicsMailbox, &cmd, (~(0))))
    	{
    		switch(cmd.type)
    		{
    		...
    		case _COMMAND_CONN_UPDATE:
                ...
                WidgetMessageQueueAdd((tWidget *)&g_sConnStatus, 0x00000001, 0, 0, 0, 0);
    			break;
    		case _COMMAND_PTR_DOWN:
    			...
    			WidgetPointerMessage(0x00000002, cmd.args[0], cmd.args[1]);
    			break;
    		case _COMMAND_PTR_UP:
    			if (!SSD1289_Get_Backlight_On())
    			{
        			SSD1289_Set_Backlight_On(1);
    				break;
    			}

    			WidgetPointerMessage(0x00000004, cmd.args[0], cmd.args[1]);
    			break;
    		...
    		case _COMMAND_REPAINT:
    			WidgetMessageQueueAdd((tWidget *)cmd . args[0], 0x00000001, 0, 0, 0, 0);
    			break;
...
Init_UI(void)
{
	ti_sysbios_knl_Mailbox_Params mbparams;
	ti_sysbios_knl_Mailbox_Params_init(&mbparams);
	static xdc_runtime_Error_Block eb;

	GraphicsMailbox = ti_sysbios_knl_Mailbox_create(sizeof(Command),20,&mbparams,&eb);
}
