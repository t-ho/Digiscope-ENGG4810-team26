...
RectangularButton(g_sPrevious, 0, 0, 0, &SSD1289_Display, 0, 190,
                  50, 50, PB_STYLE_FILL | PB_STYLE_TEXT, ClrRed, ClrYellow, ClrBlue,
				  ClrSilver, &g_sFontCm20, "-", 0,
				  0, 0, 0, OnPrevious);

Canvas(g_sTitle, 0, 0, 0, &SSD1289_Display, 50, 190, 220, 50,
       CANVAS_STYLE_TEXT | CANVAS_STYLE_TEXT_OPAQUE, 0, 0, ClrSilver,
       &g_sFontCm20, 0, 0, 0);

RectangularButton(g_sNext, 0, 0, 0, &SSD1289_Display, 270, 190,
...
screenDemo(UArg arg0, UArg arg1)
{
    ...
    CanvasTextSet(&g_sTitle, "Test title");
