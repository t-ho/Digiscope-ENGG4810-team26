...
#define LCD_DATA_2_B	GPIO_PORTH_BASE
#define LCD_DATA_3_B	GPIO_PORTH_BASE
#define LCD_DATA_4_B	GPIO_PORTM_BASE
#define LCD_DATA_5_B	GPIO_PORTM_BASE
#define LCD_DATA_6_B	GPIO_PORTM_BASE
#define LCD_DATA_7_B	GPIO_PORTK_BASE
#define LCD_DATA_8_B	GPIO_PORTA_BASE
#define LCD_DATA_9_B	GPIO_PORTA_BASE
#define LCD_DATA_10_B	GPIO_PORTK_BASE
#define LCD_DATA_11_B	GPIO_PORTK_BASE
#define LCD_DATA_12_B	GPIO_PORTK_BASE
#define LCD_DATA_13_B	GPIO_PORTK_BASE
#define LCD_DATA_14_B	GPIO_PORTB_BASE
#define LCD_DATA_15_B	GPIO_PORTB_BASE

#define LCD_RS_B		GPIO_PORTA_BASE
#define LCD_WR_B		GPIO_PORTP_BASE
#define LCD_RD_B		GPIO_PORTM_BASE
...
#define LCD_DATA_2_P	GPIO_PIN_1
#define LCD_DATA_3_P	GPIO_PIN_0
#define LCD_DATA_4_P	GPIO_PIN_2
#define LCD_DATA_5_P	GPIO_PIN_1
#define LCD_DATA_6_P	GPIO_PIN_0
#define LCD_DATA_7_P	GPIO_PIN_5
#define LCD_DATA_8_P	GPIO_PIN_5
#define LCD_DATA_9_P	GPIO_PIN_4
#define LCD_DATA_10_P	GPIO_PIN_3
#define LCD_DATA_11_P	GPIO_PIN_2
#define LCD_DATA_12_P	GPIO_PIN_1
#define LCD_DATA_13_P	GPIO_PIN_0
#define LCD_DATA_14_P	GPIO_PIN_5
#define LCD_DATA_15_P	GPIO_PIN_4

#define LCD_RS_P		GPIO_PIN_7
#define LCD_WR_P		GPIO_PIN_5
#define LCD_RD_P		GPIO_PIN_7
...
{
//#define LCD_DATA_8_B	GPIO_PORTA_BASE		GPIO_PIN_5
//#define LCD_DATA_9_B	GPIO_PORTA_BASE		GPIO_PIN_4
//
//#define LCD_DATA_14_B	GPIO_PORTB_BASE		GPIO_PIN_5
//#define LCD_DATA_15_B	GPIO_PORTB_BASE		GPIO_PIN_4
//
//#define LCD_DATA_2_B	GPIO_PORTH_BASE		GPIO_PIN_1
//#define LCD_DATA_3_B	GPIO_PORTH_BASE		GPIO_PIN_0
//
//#define LCD_DATA_0_B	GPIO_PORTK_BASE		GPIO_PIN_7
//#define LCD_DATA_1_B	GPIO_PORTK_BASE		GPIO_PIN_6
//#define LCD_DATA_7_B	GPIO_PORTK_BASE		GPIO_PIN_5
//#define LCD_DATA_10_B	GPIO_PORTK_BASE		GPIO_PIN_3
//#define LCD_DATA_11_B	GPIO_PORTK_BASE		GPIO_PIN_2
//#define LCD_DATA_12_B	GPIO_PORTK_BASE		GPIO_PIN_1
//#define LCD_DATA_13_B	GPIO_PORTK_BASE		GPIO_PIN_0
//
//#define LCD_DATA_4_B	GPIO_PORTM_BASE		GPIO_PIN_2
//#define LCD_DATA_5_B	GPIO_PORTM_BASE		GPIO_PIN_1
//#define LCD_DATA_6_B	GPIO_PORTM_BASE		GPIO_PIN_0

	MAP_GPIOPinWrite(GPIO_PORTA_BASE,
			LCD_DATA_8_P | LCD_DATA_9_P,
			LCDOUTB(5,8) | LCDOUTB(4,9)
			);

	MAP_GPIOPinWrite(GPIO_PORTB_BASE,
			LCD_DATA_14_P | LCD_DATA_15_P,
			LCDOUTB(5,14) | LCDOUTB(4,15)
			);

	MAP_GPIOPinWrite(GPIO_PORTH_BASE,
			LCD_DATA_2_P | LCD_DATA_3_P,
			LCDOUTB(1,2) | LCDOUTB(0,3)
			);

	MAP_GPIOPinWrite(GPIO_PORTK_BASE,
			LCD_DATA_0_P | LCD_DATA_1_P | LCD_DATA_7_P | LCD_DATA_10_P | LCD_DATA_11_P | LCD_DATA_12_P | LCD_DATA_13_P,
			LCDOUTP(7,0) | LCDOUTP(6,1) | LCDOUTB(5,7) | LCDOUTB(3,10) | LCDOUTB(2,11) | LCDOUTB(1,12) | LCDOUTB(0,13)
			);

	MAP_GPIOPinWrite(GPIO_PORTM_BASE,
			LCD_DATA_4_P | LCD_DATA_5_P | LCD_DATA_6_P,
			LCDOUTB(2,4) | LCDOUTB(1,5) | LCDOUTB(0,6)
			);
